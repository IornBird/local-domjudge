...
1. 教師以專用密碼認證。以程式(考慮分為完整版)打包題目，並經測試確認無虞
  
2. 提供學生程式(考慮分為學生版)與封裝檔
  
3. 考試開始時，以非程式方式(例如寫在白板上)提供公開密碼。
  
4. 每次程式啟動，學生只需輸入一次公開密碼。
  
5. 教師在考試結束/學生提早離場當下，拍攝最後一次批改結果。(考慮中)或以隨身碟紀錄報表。
